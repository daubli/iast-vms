...
public final class String
    ...
    public String substring(int beginIndex) {
        ...
        String result = isLatin1() ? StringLatin1.newString(value, beginIndex, subLen)
    ...
    public String concat(String str) {
        ...
        if (olen == 0) {
            ...
            if(this.getTaint() || (str!= null && str.getTaint()))
            {
                result.setTaint(taint);
            }
        ...
        if (coder() == str.coder()) {
            ...
            String result = new String(buf, coder);
            if(this.taint || (str!= null && str.getTaint())){
        ...
        String result = new String(buf, UTF16);
        if(this.taint || (str!= null && str.getTaint())){
            result.setTaint(true);
        }
        return result;
    ...
    public String toLowerCase(Locale locale) {
        String result =  isLatin1() ? StringLatin1.toLowerCase(this, value, locale)
                : StringUTF16.toLowerCase(this, value, locale);
        result.setTaint(getTaint());
        return result;
    }
    ...
    public String toUpperCase(Locale locale) {
        String result = isLatin1() ? StringLatin1.toUpperCase(this, value, locale)
